'''no need anymore watch djangosavetosql'''
# import sqlite3
#
#
...
#     sql_str = "INSERT INTO csinf_skininfo(name,steam_price,market_price,market_order,buff_price,buff_order, sb,sm,mb,ms," \
#               "bm, bs,market_7d,num_sell_buff,num_order_buff, buff_link,market_link,steam_link) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
